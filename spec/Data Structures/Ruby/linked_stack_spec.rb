require 'rspec'
require_relative '../../../Data Structures/Ruby/linked-stack'

describe LinkedStack do
  let(:linked_stack) { LinkedStack.new }
  it '#peek will reveal the top of the stack' do
  ...
  it '#push adds an element to the top of the stack' do
    linked_stack.push('hello')
  ...
  it '#pop removes the last element added to the stack and returns it' do
    linked_stack.push('hello')
    linked_stack.push('world')
  ...
  it '#empty? returns true if there are no elements on the stack' do
